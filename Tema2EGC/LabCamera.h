	...
	class Camera
	{
		public:
			...
			void RotateFirstPerson_OX(float angle)
			{
				...
				// Use glm::rotate()
				forward = glm::normalize(glm::rotate(glm::mat4(1), angle, right) *
										glm::vec4(forward, 0));
			...
			void RotateFirstPerson_OY(float angle)
			{
				...
				// Use glm::rotate()
				forward = glm::normalize(glm::rotate(glm::mat4(1), angle, aux) *
										glm::vec4(forward, 0));
				right = glm::normalize(glm::rotate(glm::mat4(1), angle, aux) *
										glm::vec4(right, 0));
			...
			void RotateFirstPerson_OZ(float angle)
			{
				...
				// Don't forget to normalize the vectors
				forward = glm::normalize(glm::rotate(glm::mat4(1), angle, forward) *
					glm::vec4(up, 0));
				right = glm::normalize(glm::rotate(glm::mat4(1), angle, aux) *
					glm::vec4(right, 1));
				up = glm::cross(right, forward);
